#Object Detection and Camera Control Web Interface
#Author: Marek Augustyn
#Description: A Flask web application that streams video from a camera device,
# allowing users to view the feed and control camera settings via v4l2-ctl.
# Using index.2.html template for the web interface.
# Feb 2026 Not ready at the moment just a control stream
# Decited not continue with this because I have to use a docker container to make an object detection unless
# I make a code that will have a class that will activate a container and do the object deection
...
PORT = int(os.environ.get("STREAM_PORT", "5003"))  # choose different port if needed
