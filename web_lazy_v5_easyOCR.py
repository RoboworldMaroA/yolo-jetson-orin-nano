...
def producer():
    ...
    while not stop_event.is_set():
        ...
        try:
            ...
            elif manager.active in ("plate-recognition", "irish-plate-recognition"):
...
@app.route('/')
def index():
    return render_template('index_lazy_v5.html')
...
def switch_model():
    ...
    if name not in ("detection", "pose", "segmentation", "custom-model", "plate-recognition", "irish-plate-recognition"):
