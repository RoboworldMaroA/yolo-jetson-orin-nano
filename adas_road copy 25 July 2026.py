...
# WORKING save recordnig with full hd but is slowing down because recording is in main loop
...
def producer():
    ...
    while not stop_event.is_set():
        ...
        # Recording inside the adas_rad.py is not working because of permition docket image to the libraries
